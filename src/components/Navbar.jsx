      ...
      <nav className="border-b-2 py-8 flex justify-between items-center">
        ...
        <div className="flex gap-24">
          ...
          <ul
            ...
            } z-100 md:translate-x-0 fixed top-0 left-0 bottom-0 md:static flex flex-col md:flex-row md:gap-4 md:bg-transparent md:p-0 pl-6 pr-16 py-12 gap-4 bg-white transition-all w-4/6 md:w-auto z-50`}
          >
          ...
          <div className="relative" >
            ...
            {cartOpen ? (
              <div className="hidden md:block absolute top-[300%] left-1/2 -translate-x-1/2  bg-white shadow-2xl rounded-lg shadow-gray-400 px-4 py-6">
                ...
                {(count !== 0 && cart)? <div className="flex flex-col items-stretch">
                ...
                <button className="py-2 px-4 bg-[#ff7d1a] rounded-lg  gap-4 font-bold w-full items-center justify-center cursor-pointer" onClick={handleEmptyCart}>
                  Checkout
                </button>
                    
                </div> : <div className="min-w-64 min-h-24 grid place-content-center h-full">
                    Your cart is empty.
                </div>}
